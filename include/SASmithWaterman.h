...
private:
  ...
  void cacheAllMatches(ContainerType &Seq1, ContainerType &Seq2) {
    ...
    newfile << "STARTED SMITH WATERMAN\n";
    ...
    //newfile << "MatrixRows: " << MatrixRows << " MatrixCols: " << MatrixCols << "\n";
    //newfile.close();
  ...
  void buildResult(ContainerType &Seq1, ContainerType &Seq2,
    ...
    newfile.open(newPath, std::ios_base::app);
    newfile << "Seq1 Size: " << Seq1.size() << " Seq2 Size: " << Seq2.size() << "\n";
    newfile << "MaxRow: " << MaxRow << " MaxCol: " << MaxCol << "\n";
    newfile.close();*/
    ...
    /*newfile.open(newPath, std::ios_base::app);
    newfile << "COMPLETED SMITH WATERMAN\n";
    newfile.close();*/
  }
...
public:
  static ScoringSystem getDefaultScoring() { return ScoringSystem(-1, 1, -1); }
