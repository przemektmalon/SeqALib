#ifndef ADT_ARRAY_VIEW_H
#define ADT_ARRAY_VIEW_H
...
public:
    ...
    ArrayView(iterator Begin, iterator End, reverse_iterator RBegin, reverse_iterator REnd) : Begin(Begin), End(End), RBegin(RBegin), REnd(REnd)
    {
        Size = End - Begin;
    }
